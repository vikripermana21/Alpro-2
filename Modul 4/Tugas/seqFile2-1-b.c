    ...
    bukuPtr=fopen("harga>=1000.dat", "rb");
        }else{
    bukuPtr=fopen("harga<1000.dat", "rb");
        }
    ...
    printf("3. Split File menjadi 2 bagian Harga Sewa ≥ Rp. 1.000 dan harga sewa < Rp. 1.000\n");
    printf("4. Tampilkan data buku dengan harga >= 1000 (lakukan step 3 terlebih dahulu)\n");
    printf("5. Tampilkan data buku dengan harga < 1000(lakukan step 3 terlebih dahulu)\n");
    printf("9. Exit \n");
